        ...
        <div>
            ...
            <div className='sm:w-[500px] m-auto border space-y-6 py-8 px-4 rounded-md'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="password" name='oldPassword' onChange={(e) => setUdata({...udata, oldPassword: e.target.value})} value={udata.oldPassword} className='border rounded-lg p-2 '/>
                </div>

                <div className='flex flex-col'>
                    <label htmlFor="" className='font-semibold'>New Password</label>
                    <input type="password" name='newPassword' onChange={(e) => setUdata({...udata, newPassword : e.target.value})} value={udata.newPassword} className='border rounded-lg p-2'/>
                </div>
